    ...
    <>
      <FormFieldsGroup>
        ...
        <FormField>
          ...
          <Input name="image" id="image" type="file" accept="image/*" disabled={pending} hidden={readOnly} />
          <ImageForm
        ...
        <FormField>
          ...
          <Input name="name" id="name" placeholder="Insira o nome do artigo esportivo" defaultValue={sportsItem?.name} />
        </FormField>
        ...
        <FormField>
          ...
          <Input name="brand" id="brand" placeholder="Insira a marca do artigo esportivo" defaultValue={sportsItem?.brand} />
        </FormField>
        <FormField>
        ...
        <FormField>
            ...
            <Input name="year" id="year" maxLength={4} placeholder="Insira o ano do artigo esportivo" defaultValue={sportsItem?.year} />
        </FormField>
        <FormField>
        ...
        <FormField>
              ...
              <Input name="amount" id="amount" placeholder="Insira a quantidade do artigo esportivo" defaultValue={sportsItem?.amount} />
        </FormField>
      </FormFieldsGroup>
